...
class IFCElementExtractor:
    ...
    def run(self, storeys=None):
        ...
        for storey_name, segs in grouped.items():
            ...
            # Build file paths
            csv_path = os.path.join(self.output_dir, f"{safe}.csv")
            dxf_path = os.path.join(self.output_dir, f"{safe}.dxf")
            svg_path = os.path.join(self.output_dir, f"{safe}.svg")
            png_path = os.path.join(self.output_dir, f"{safe}.png")
